...
import Moment from 'react-moment'; const imgStye = {
    ...
    return (
        <div>
            ...
            <div>
                {props.infoclean.created_at ? <div><p>Joined Github:</p><p>{
            ...
            <div>
                {props.infoclean.public_repos ? <div><p>Public Repositories:</p><p>{props.infoclean.public_repos}</p></div> : null}
            </div>
            <div>
                {props.infoclean.followers ? <div><p>Number of Followers:</p><p>{props.infoclean.followers}</p></div> : null}
            </div>
            <div>
                {props.infoclean.following ? <div><p>Number Following:</p><p>{props.infoclean.following}</p></div> : null}
            </div>
            <div>
